...
- feat: do not mutate nested objects on resolver merge (dsamsonov@microsoft.com)
...
- FragmentSpread is added into extractMinimalViableSchemaForRequestDocument (77059398+vejrj@users.noreply.github.com)
